...
parser.add_argument(
    "--splitted_data_dir", type=str, default=None
...
parser.add_argument("--favorable_label", type=int, default=None)
parser.add_argument("--unfavorable_label", type=int, default=None)
parser.add_argument("--priv_group", type=int, default=None)
parser.add_argument("--unpriv_group", type=int, default=None)
parser.add_argument("--debias_approach", type=str, default="local")
...
if __name__ == "__main__":
    ...
    train_parameters = TrainParameters(
        ...
        priv_group=args.priv_group,
        unpriv_group=args.unpriv_group,
    ...
    if args.tabular_data:
        ...
        fed_dir, _, weights = prepare_tabular_data(
        ...
        if weights is not None and args.debias and args.debias_approach == "global":
            with open(f"{fed_dir}/weights.pkl", "wb") as file:
                dill.dump(weights, file)
    else:
