...
def data_preprocess(num_clients, trainloaders, valloaders, sensitive_attributes, sens_att):
    """
    ...
    for i in range(num_clients):
        ...
        for data in trainloaders[i]:
            ...
            for s in range(num_sensitive):
                ...
                matched = torch.sum((matched1 == matched2)*(matched2==True))
        ...
        for data in valloaders[i]:
            ...
            for s in range(num_sensitive):
                ...
                # num_sensitive_per_client[i][s] += matched
                num_total_sensitive_samples[s] += matched
        print(num_total_sensitive_samples)
    # returning final metrics:
    print(num_total_samples, num_total_sensitive_samples)
    print("-------------------------------- End --------------------------------")
