...
path = "/home/heilmann/Dokumente/MultipleObjectiveFL/Improving-Fairness-via-Federated-Learning-main/FedFB/sampled_data/"
...
def load_iid(num_clients, b_size, sens_attr, comp_attr):
    ...
    testset =pd.read_csv("/home/heilmann/Dokumente/MultipleObjectiveFL/Improving-Fairness-via-Federated-Learning-main/FedFB/sampled_data/WY.csv")
